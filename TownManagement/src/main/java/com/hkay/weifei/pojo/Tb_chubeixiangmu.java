...
public class Tb_chubeixiangmu {
	...
	public void setResjoinway(String resjoinway) {
		this.resjoinway = resjoinway;
	}
	public String getRescompetentunit() {
		return rescompetentunit;
	}
	...
	public void setRescontactunit(String rescontactunit) {
		this.rescontactunit = rescontactunit;
	}
	public String getRescontacts() {
		return rescontacts;
	}
	public void setRescontacts(String rescontacts) {
		this.rescontacts = rescontacts;
	}
	public String getRescontactway() {
		return rescontactway;
	}
