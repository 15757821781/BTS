...
public class Tb_qiyedanwei {
	private String comid; // 企业单位ID
	private String comname;// 企业单位名称
	private String comnumber;// 企业单位编号
...
//	private String comregtown;//投资乡镇
	...
	public String getComprivatefive() {
		return comprivatefive;
	}

	public void setComprivatefive(String comprivatefive) {
		this.comprivatefive = comprivatefive;
	}
	...
	public String getComcapitalunit() {
		return comcapitalunit;
	}

	public void setComcapitalunit(String comcapitalunit) {
		this.comcapitalunit = comcapitalunit;
	}
	...
	public String getComregpro() {
		return comregpro;
	}

	public void setComregpro(String comregpro) {
		this.comregpro = comregpro;
	}

	public String getComregcity() {
		return comregcity;
	}

	public void setComregcity(String comregcity) {
