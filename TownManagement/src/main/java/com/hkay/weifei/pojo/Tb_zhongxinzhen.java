...
public class Tb_zhongxinzhen {
	...
	private double townarea;// 镇域面积
	private double builtuparea;// 建成面积
	private double townpopulation;// 镇域人口
	private double floatepopulation;// 流动人口
	private double countygdp;// 区县级GDP
	private double countyrevenue;// 区县级财政收入
	private double townrevenue;// 镇级财政收入
	...
	private String historyculture;// 历史文化及名人
	...
	public double getFloatepopulation() {
		return floatepopulation;
	}

	public void setFloatepopulation(double floatepopulation) {
		this.floatepopulation = floatepopulation;
	}
